...
const TRANSLATIONS = {
  ...
  'pricing.rent.day': { en: '1 Day Rent + 1 Pack Job', de: '1 Tag Miete + 1 Pack Job', it: '1 Giorno Noleggio + 1 Pack Job', lad: '1 Dì Nolëi + 1 Pack Job', nl: '1 Dag Huur + 1 Pack Job', fr: '1 Jour Location + 1 Pack Job', pl: '1 Dzień Wynajem + 1 Pack Job', es: '1 Día Alquiler + 1 Pack Job', cs: '1 Den Pronájem + 1 Pack Job' },
  'pricing.rent.additional': { en: 'Each additional day', de: 'Jeder weitere Tag', it: 'Ogni giorno aggiuntivo', lad: 'Vigni dì adiziunel', nl: 'Elke extra dag', fr: 'Chaque jour supplémentaire', pl: 'Każdy dodatkowy dzień', es: 'Cada día adicional', cs: 'Každý další den' },
  ...
  'map.title': { en: 'Our Locations', de: 'Unsere Standorte', it: 'Le nostre posizioni', lad: 'Nostes posizions', nl: 'Onze locaties', fr: 'Nos emplacements', pl: 'Nasze lokalizacje', es: 'Nuestras ubicaciones', cs: 'Naše polohy' },
  'map.subtitle': { en: 'Two jump locations in the heart of the Dolomites UNESCO World Heritage Site, South Tyrol.', de: 'Zwei Sprunggebiete im Herzen des UNESCO-Welterbes Dolomiten, Südtirol.', it: 'Due zone di salto nel cuore del sito UNESCO delle Dolomiti, in Alto Adige.', lad: 'Doi lueches de sauc ite l cuer dl sit UNESCO dles Dolomites, Sudtirol.', nl: 'Twee springlocaties in het hart van het UNESCO Werelderfgoed Dolomieten, Zuid-Tirol.', fr: 'Deux zones de saut au cœur du site UNESCO des Dolomites, Haut-Adige.', pl: 'Dwie lokalizacje skoków w sercu Dolomitów — Dziedzictwa UNESCO, Tyrol Południowy.', es: 'Dos zonas de salto en el corazón del Patrimonio UNESCO de los Dolomitas, Tirol del Sur.', cs: 'Dvě seskoková místa v srdci dolomitského světového dědictví UNESCO, Jižní Tyrolsko.' },
  'map.saslong.title': { en: '📍 Saslong — 1,600m Jump', de: '📍 Saslong — 1.600m Sprung', it: '📍 Saslong — Salto 1.600m', lad: '📍 Saslong — Sauc 1.600m', nl: '📍 Saslong — 1.600m Sprong', fr: '📍 Saslong — Saut 1 600m', pl: '📍 Saslong — Skok 1 600m', es: '📍 Saslong — Salto 1.600m', cs: '📍 Saslong — Seskok 1 600m' },
  'map.saslong.desc': { en: 'Landing zone near the famous Saslong slope, Val Gardena.', de: 'Landezone nahe der berühmten Saslong-Piste, Gröden.', it: 'Zona di atterraggio vicino alla famosa pista Saslong, Val Gardena.', lad: 'Zona de aterëi dlongia la famosa pista Saslong, Gherdëina.', nl: 'Landingszone nabij de beroemde Saslong-piste, Val Gardena.', fr: 'Zone d\'atterrissage près de la célèbre piste Saslong, Val Gardena.', pl: 'Strefa lądowania przy słynnym stoku Saslong, Val Gardena.', es: 'Zona de aterrizaje cerca de la famosa pista Saslong, Val Gardena.', cs: 'Přistávací zóna u slavného svahu Saslong, Val Gardena.' },
  'map.montdecoi.title': { en: '📍 Mont de Côi — 2,500m Jump', de: '📍 Mont de Côi — 2.500m Sprung', it: '📍 Mont de Côi — Salto 2.500m', lad: '📍 Mont de Côi — Sauc 2.500m', nl: '📍 Mont de Côi — 2.500m Sprong', fr: '📍 Mont de Côi — Saut 2 500m', pl: '📍 Mont de Côi — Skok 2 500m', es: '📍 Mont de Côi — Salto 2.500m', cs: '📍 Mont de Côi — Seskok 2 500m' },
  'map.montdecoi.desc': { en: 'Landing zone at Sportzentrum Mont de Côi, St. Christina / S. Cristina.', de: 'Landezone am Sportzentrum Mont de Côi, St. Christina.', it: 'Zona di atterraggio al Centro Sportivo Mont de Côi, S. Cristina.', lad: 'Zona de aterëi al Zentrum Sportif Mont de Côi, S. Cristina.', nl: 'Landingszone bij Sportzentrum Mont de Côi, St. Christina.', fr: 'Zone d\'atterrissage au centre sportif Mont de Côi, S. Cristina.', pl: 'Strefa lądowania przy centrum sportowym Mont de Côi, St. Christina.', es: 'Zona de aterrizaje en Sportzentrum Mont de Côi, S. Cristina.', cs: 'Přistávací zóna u sportovního centra Mont de Côi, St. Christina.' },
  ...
  'experience.step1.title': { en: 'Book Online', de: 'Online buchen', it: 'Prenota online', lad: 'Prenota online', nl: 'Online boeken', fr: 'Réserver en ligne', pl: 'Zarezerwuj online', es: 'Reservar online', cs: 'Rezervovat online' },
  'experience.step1.text': {
    ...
    nl: 'Reserveer je helikopterplek direct via ons boekingsplatform — kies je datum, vul je gegevens in en zeker je plek.',
    fr: 'Réservez votre place en hélicoptère directement sur notre plateforme — choisissez la date, remplissez vos infos et sécurisez votre place.',
    pl: 'Zarezerwuj miejsce w helikopterze bezpośrednio na naszej platformie — wybierz datę, podaj dane i zabezpiecz swoje miejsce.',
    es: 'Reserva tu plaza de helicóptero directamente en nuestra plataforma — selecciona la fecha, rellena tus datos y asegura tu asiento.',
    cs: 'Rezervujte si místo ve vrtulníku přímo přes naši platformu — vyberte datum, vyplňte údaje a zajistěte si místo.'
  },
  ...
  'req.payment.text': { en: 'Book exclusively via our platform — balance payable on site', de: 'Ausschließlich über unsere Plattform buchen — Restbetrag vor Ort', it: 'Prenota esclusivamente sulla nostra piattaforma — saldo in loco', lad: 'Prenota mec sëura nosta plataforma — saldo sö l post', nl: 'Boek uitsluitend via ons platform — restbedrag ter plaatse', fr: 'Réservez exclusivement via notre plateforme — solde sur place', pl: 'Rezerwuj wyłącznie przez naszą platformę — dopłata na miejscu', es: 'Reserva exclusivamente en nuestra plataforma — saldo en el lugar', cs: 'Rezervujte výhradně přes naši platformu — doplatek na místě' },
  ...
  'faq.a3': {
    ...
    nl: 'Boek je sprong uitsluitend via onze website. Kies je datum en helikopterlading, vul je gegevens in en reserveer je plek met een aanbetaling. Het restbedrag betaal je ter plaatse.',
    fr: 'Réservez votre saut exclusivement via notre site web. Sélectionnez la date et le load, remplissez vos informations et réservez votre place avec un acompte. Le solde se paie sur place.',
    pl: 'Zarezerwuj skok wyłącznie przez naszą stronę internetową. Wybierz datę i load helikoptera, wypełnij dane i zabezpiecz miejsce zaliczką. Reszta płatna na miejscu.',
    es: 'Reserva tu salto exclusivamente a través de nuestra web. Selecciona fecha y load, completa tus datos y asegura tu plaza con un depósito. El saldo se paga en el lugar.',
    cs: 'Zarezervujte si seskok výhradně přes naše webové stránky. Vyberte datum a load vrtulníku, vyplňte údaje a zajistěte si místo zálohou. Doplatek se platí na místě.'
  },
  ...
  'faq.q7': { en: 'Can I book the helicopter directly?', de: 'Kann ich den Helikopter direkt buchen?', it: 'Posso prenotare l\'elicottero direttamente?', lad: 'Poi prenota l\'elicòter diretamënter?', nl: 'Kan ik de helikopter rechtstreeks boeken?', fr: 'Puis-je réserver l\'hélicoptère directement ?', pl: 'Czy mogę zarezerwować helikopter bezpośrednio?', es: '¿Puedo reservar el helicóptero directamente?', cs: 'Mohu si zarezervovat vrtulník přímo?' },
  'faq.a7': {
    ...
    nl: 'Nee. Alle helikopterboekingen voor skydiven worden uitsluitend beheerd door Time to Jump Dolomites. Neem geen rechtstreeks contact op met de helikopteroperator.',
    fr: 'Non. Toutes les réservations d\'hélicoptère pour le parachutisme sont gérées exclusivement par Time to Jump Dolomites. Ne contactez pas directement l\'opérateur.',
    pl: 'Nie. Wszystkie rezerwacje helikoptera na skoki są zarządzane wyłącznie przez Time to Jump Dolomites. Prosimy nie kontaktować się bezpośrednio z operatorem helikoptera.',
    es: 'No. Todas las reservas de helicóptero para paracaidismo se gestionan exclusivamente a través de Time to Jump Dolomites. No contactes directamente con el operador del helicóptero.',
    cs: 'Ne. Všechny rezervace vrtulníku pro seskoky jsou spravovány výhradně přes Time to Jump Dolomites. Nekontaktujte prosím provozovatele vrtulníku přímo.'
  },
  ...
  'upcoming.hiw.step1.text': { en: 'Pay a deposit equal to your share of the helicopter cost to guarantee your seat.', de: 'Zahle eine Anzahlung in Höhe deines Helikopteranteils, um deinen Platz zu sichern.', it: 'Paga un deposito pari alla tua quota elicottero per garantire il tuo posto.', lad: 'Paia n deposit uguel a tua cuota dl elicòter per garantì to post.', nl: 'Betaal een aanbetaling ter hoogte van je aandeel in de helikopterkosten.', fr: 'Payez un acompte égal à votre part du coût de l\'hélicoptère.', pl: 'Wpłać zaliczkę równą Twojemu udziałowi w kosztach helikoptera.', es: 'Paga un depósito igual a tu parte del coste del helicóptero.', cs: 'Zaplaťte zálohu ve výši vašeho podílu na nákladech na vrtulník.' },
  ...
  'upcoming.hiw.step2.text': { en: 'The helicopter cost splits equally across all booked participants — the more join, the less you pay.', de: 'Die Helikopterkosten werden gleichmäßig aufgeteilt — je mehr mitmachen, desto günstiger wird es.', it: 'Il costo dell\'elicottero viene diviso equamente — più partecipanti, meno paghi.', lad: 'L cost dl elicòter vën dividì cumpaniëus — plü partezipanc, manciamënt paies.', nl: 'De helikopterkosten worden gelijk verdeeld — hoe meer deelnemers, hoe lager de prijs.', fr: 'Le coût de l\'hélicoptère est réparti équitablement — plus il y a de participants, moins vous payez.', pl: 'Koszt helikoptera dzielony jest równo — im więcej uczestników, tym mniej płacisz.', es: 'El coste del helicóptero se divide entre todos — cuantos más participen, menos pagas.', cs: 'Náklady na vrtulník se rovnoměrně rozdělí — čím více účastníků, tím méně platíte.' },
  ...
  'upcoming.hiw.step3.text': { en: 'Pay only the remaining balance on-site on the day of the jump (card or cash).', de: 'Zahle den Restbetrag am Sprungtag vor Ort (Karte oder Bar).', it: 'Paga solo il saldo residuo in loco il giorno del salto (carta o contanti).', lad: 'Paia mec l saldo che resta sö l post l dì dl sauc (ciarta o cuntanc).', nl: 'Betaal alleen het restbedrag ter plaatse op de dag van de sprong (kaart of contant).', fr: 'Payez uniquement le solde sur place le jour du saut (carte ou espèces).', pl: 'Zapłać tylko pozostałą kwotę na miejscu w dniu skoku (kartą lub gotówką).', es: 'Paga solo el saldo restante en el lugar el día del salto (tarjeta o efectivo).', cs: 'Zaplaťte pouze doplatek na místě v den seskoku (kartou nebo hotově).' },
  ...
  // ---- PRICING LABEL ----
  'pricing.label': { en: 'Prices 2026', de: 'Preise 2026', it: 'Prezzi 2026', lad: 'Priesc 2026', nl: 'Prijzen 2026', fr: 'Tarifs 2026', pl: 'Cennik 2026', es: 'Precios 2026', cs: 'Ceny 2026' },

  // ---- REQUIREMENTS ----
  'req.license.title': { en: 'License Required', de: 'Lizenz erforderlich', it: 'Licenza richiesta', lad: 'Licënza debujën', nl: 'Licentie vereist', fr: 'Licence requise', pl: 'Wymagana licencja', es: 'Licencia requerida', cs: 'Vyžadována licence' },
  'req.license.text': { en: 'Professional skydivers only — valid license mandatory', de: 'Nur professionelle Springer — gültige Lizenz Pflicht', it: 'Solo paracadutisti autonomi — licenza valida obbligatoria', lad: 'Mec paracadutisć autonoms — licënza valida obligatoria', nl: 'Alleen professionele skydivers — geldige licentie verplicht', fr: 'Parachutistes autonomes uniquement — licence valide obligatoire', pl: 'Tylko doświadczeni skoczkowie — ważna licencja obowiązkowa', es: 'Solo paracaidistas autónomos — licencia válida obligatoria', cs: 'Pouze zkušení parašutisté — platná licence povinná' },
  'req.safety.title': { en: 'Safety First', de: 'Sicherheit zuerst', it: 'Sicurezza prima di tutto', lad: 'Segurëza dant l rest', nl: 'Veiligheid eerst', fr: 'Sécurité d\'abord', pl: 'Bezpieczeństwo przede wszystkim', es: 'Seguridad ante todo', cs: 'Bezpečnost na prvním místě' },
  'req.safety.text': { en: 'Full gear inspection required before every jump', de: 'Vollständige Ausrüstungskontrolle vor jedem Sprung', it: 'Controllo completo dell\'attrezzatura prima di ogni salto', lad: 'Control complet dl echipamënt dant vigni sauc', nl: 'Volledige materiaalcontrole voor elke sprong', fr: 'Inspection complète du matériel avant chaque saut', pl: 'Pełna kontrola sprzętu przed każdym skokiem', es: 'Inspección completa del equipo antes de cada salto', cs: 'Úplná kontrola vybavení před každým seskokem' },
  'req.weather.title': { en: 'Weather Dependent', de: 'Wetterabhängig', it: 'Dipende dal meteo', lad: 'Depënn dal tëmp', nl: 'Weerafhankelijk', fr: 'Dépendant de la météo', pl: 'Zależne od pogody', es: 'Depende del clima', cs: 'Závisí na počasí' },
  'req.weather.text': { en: 'Jumps depend on conditions — flexible rescheduling available', de: 'Sprünge wetterabhängig — flexible Umplanung möglich', it: 'I salti dipendono dalle condizioni — riprogrammazione flessibile', lad: 'I sauc depënn dal tëmp — reprogramaziun flesibla', nl: 'Sprongen afhankelijk van weersomstandigheden — flexibel herplannen', fr: 'Les sauts dépendent des conditions — report flexible', pl: 'Skoki zależą od warunków — elastyczne zmiany terminów', es: 'Los saltos dependen de las condiciones — reprogramación flexible', cs: 'Seskoky závisí na podmínkách — flexibilní přeplánování' },
  'req.payment.title': { en: 'Easy Booking', de: 'Einfache Buchung', it: 'Prenotazione facile', lad: 'Prenotaziun fazila', nl: 'Eenvoudig boeken', fr: 'Réservation facile', pl: 'Łatwa rezerwacja', es: 'Reserva fácil', cs: 'Snadná rezervace' },
  'req.payment.text': { en: 'Book exclusively via our platform — balance payable on site', de: 'Buchung ausschließlich über unsere Plattform — Restbetrag vor Ort', it: 'Prenota esclusivamente sulla nostra piattaforma — saldo in loco', lad: 'Prenota esclusivamënter söla nosta plataforma — saldo sö l post', nl: 'Boek uitsluitend via ons platform — restbedrag ter plaatse', fr: 'Réservez exclusivement via notre plateforme — solde sur place', pl: 'Rezerwuj wyłącznie przez naszą platformę — reszta na miejscu', es: 'Reserva exclusivamente en nuestra plataforma — saldo en el lugar', cs: 'Rezervujte výhradně přes naši platformu — doplatek na místě' },
  'req.substance.title': { en: 'Zero Tolerance Policy', de: 'Null-Toleranz-Richtlinie', it: 'Politica di tolleranza zero', lad: 'Politica de toleranza zero', nl: 'Nultolerantiebeleid', fr: 'Politique de tolérance zéro', pl: 'Polityka zerowej tolerancji', es: 'Política de tolerancia cero', cs: 'Politika nulové tolerance' },
