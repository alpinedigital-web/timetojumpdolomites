...
> Letztes Update: 01.05.2026 — Davids Kurstexte integriert (Courses Section, Skydiver-Registrierung, Tandem-FAQ)
...
- **IT-Korrekturen per David (29.04.2026)**: „Assicurati il posto" statt „assicura", „con licenza" statt „professionisti", „gli skydivers" statt „i saltatori", „Vedi listino prezzi" statt „Vedi prezzi". Alle via Voice Memos und WhatsApp kommuniziert.
- **Rental Pricing Update (29.04.2026)**: Neue Zeile „1 Sprung = 25 € (ohne Packjob)" + bestehende Zeilen mit „(ohne Pack Job)" / „(no pack job)" Zusatz.
- **Offizieller Vereinsname (29.04.2026)**: Footer zeigt jetzt „Time to Jump Dolomites — associazione sportiva dilettantistica" (bzw. DE: „Sport Verein"). Dynamisch per i18n.
- **Standortkorrektur (29.04.2026)**: „Mont de Côi" → „Molin da Coi" überall. Saslong-Koordinaten auf Monte Pana korrigiert (46.543967, 11.741500). Molin da Coi: 46.565239, 11.690443.
...
## Session-Log
- **01.05.2026 (Davids Kurstexte — Courses Section)**: Davids AFF-Ausbildungstexte (EN/DE/IT) vollständig integriert. Neue Courses-Section (`#courses`) zwischen Testimonials und FAQ: 2-Phasen-Curriculum (Bolzano Theorie + Partner-Center AFF), 7-Level-Progression (Levels 1–3 Grundlagen, 4–6 Präzision, 7 Solo), Requirements (ENAC-Untersuchung, Versicherung), Included Items (8 Posten), Preisbox €3.400 mit CTA. Skydiver-Registrierungsinfo als eigener Glassmorphism-Block unter Requirements: B-Lizenz, 100 Sprünge, Haftpflichtversicherung €70/60 Tage oder €110/12 Monate. Tandem-FAQ (Q8/A8) in allen 4 Sprachen. Nav-Link "Courses" in Desktop + Mobile. ~40 neue i18n-Keys in translations.js. Pipe-separated Listen dynamisch per JS gerendert. Ladin (LAD) abgeleitet. CSS: Level-Badge mit Gold-Pulse-Animation für Level 7, responsive 2-Spalten-Grid. ROADMAP Phase 1.9 Kurse-Section als [x] markiert.
- **29.04.2026 (David's Änderungswünsche — Voice Memos + WhatsApp)**: 2 Voice Memos von David transkribiert (Whisper medium), WhatsApp-Nachrichten konsolidiert. 17 Änderungspunkte dokumentiert in `business/korrespondenz/david-aenderungswuensche-2026-04-29.md`. 12 Punkte sofort implementiert: (1) IT: „assicurati il posto" überall korrigiert. (2) IT: „professionisti" → „con licenza" (Pricing + Requirements). (3) IT: „i saltatori" → „gli skydivers" (Reviews-Heading). (4) FAQ: BASE-Lizenz + min. 100 Sprünge + Versicherung (4 Sprachen). (5) IT: „Vedi listino prezzi" bei allen Preis-CTAs. (6) Elikos komplett entfernt (Testimonials). (7) Rental: Neue Zeile „1 Jump = 25 €" + „(ohne Pack Job)" Label. (8) Footer: Offizieller Vereinsname „Time to Jump Dolomites — associazione sportiva dilettantistica" mit i18n. (9) Maps: Saslong → Monte Pana (46.543967, 11.741500). (10) Maps: Mont de Côi → Molin da Coi (46.565239, 11.690443). Verifikation: 0 verbleibende Referenzen auf Elikos, professionisti, saltatori, Mont de Côi. 5 Punkte offen: Ä2 (Short Notice IT), Ä3 (Flüge-Beschreibung), Ä4 (gleiche Daten beider Standorte — Admin Panel), Ä14 (Kurse-Section — Text ausstehend).
